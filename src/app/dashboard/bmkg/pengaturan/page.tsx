...
export default function BMKGSettingsPage() {
  ...
  // Lazy initialization untuk mencegah error linter dan hydration mismatch
    ...
    >
      ...
      <div className="flex w-full flex-col gap-3">
        ...
        >
          <div>
            ...
            <p className="text-sm font-black uppercase tracking-wide text-blue-950">
              {userData.name}
            </p>
          </div>
          <span className="text-[10px] font-bold tracking-widest text-blue-600 opacity-0 transition-opacity group-hover:opacity-100">
            UBAH
          </span>
        </div>
        ...
        >
          <div>
            ...
            <p className="text-base font-black uppercase tracking-wide text-blue-950">
              @{userData.username}
            </p>
          </div>
          <span className="text-[10px] font-bold tracking-widest text-blue-600 opacity-0 transition-opacity group-hover:opacity-100">
      ...
      <div className="mt-8">
        <button
          ...
          className="w-full rounded-md border border-slate-300 bg-white px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-blue-950 shadow-sm transition-all hover:bg-blue-950 hover:text-white"
        >
            ...
            <form onSubmit={handleSaveProfile} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-slate-300 bg-white px-4 py-2.5 text-sm font-bold text-blue-950 outline-none focus:ring-1 focus:ring-blue-950"
                />
              </div>
              <div>
                <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-slate-500">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 rounded-md bg-blue-950 py-2.5 text-[10px] font-bold uppercase tracking-widest text-white shadow-md hover:bg-blue-900 disabled:opacity-70"
                >
      ...
      {isPasswordModalOpen && (
        <div className="fixed inset-0 z-110 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-sm overflow-hidden rounded-lg bg-white p-6 shadow-xl animate-in fade-in zoom-in-95 duration-200">
            ...
            {errorMessage && (
              <div className="mb-5 rounded border border-rose-200 bg-rose-50 p-3 text-center text-[10px] font-bold uppercase text-rose-700">
                {errorMessage}
              </div>
            )}
