...
export default function BPBDKabBandungDashboard() {
  ...
  return (
    <div className={`min-h-screen bg-slate-50 flex ${outfit.className}`}>
      {/* SIDEBAR KIRI - Warna Biru-Amber Sama dengan Jabar */}
      <aside className="w-72 bg-blue-950 text-white flex flex-col shadow-2xl z-20">
        <div className="p-8 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] text-amber-400/50 font-bold uppercase tracking-[0.2em] mt-1">
                Kab. Bandung
              </span>
            </div>
          </div>
        ...
        <nav className="flex-1 p-6 space-y-3">
          ...
          <Link href="/dashboard/bpbd-kab/update-kondisi">
          ...
          <div className="pt-6 border-t border-white/5 mt-4">
            ...
            <Link href="/dashboard/bpbd-kab/tambah-user">
            ...
            <Link href="/dashboard/bpbd-kab/log-aktivitas">
