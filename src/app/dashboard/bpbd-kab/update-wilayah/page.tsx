...
export default function BPBDKabUpdateWilayahPage() {
    ...
    setTimeout(() => {
      try {
        ...
        if (editingId) {
          ...
          setSuccessMessage(
            `Data wilayah ${formData.name} berhasil diperbarui!`,
          );
        } else {
  ...
  const handleDeleteRegion = (id: number) => {
    ...
    if (
      ...
      setSuccessMessage(
        `Data wilayah ${regionToDelete?.name} berhasil dihapus.`,
      );
      setTimeout(() => setSuccessMessage(null), 4000);
    }
  };
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-base font-bold text-blue-950 outline-none transition-colors focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                />
              </div>
              <div>
                <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-slate-500">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full cursor-pointer rounded-md border border-slate-300 bg-white px-3 py-2 text-base font-bold text-blue-950 outline-none transition-colors focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                >
              ...
              <div className="grid grid-cols-2 gap-3">
                <input
                  ...
                  className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-base font-medium text-slate-700 outline-none transition-colors focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                />
                <input
                  required
                  type="text"
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-base font-bold text-blue-950 outline-none transition-colors focus:border-amber-400 focus:ring-1 focus:ring-amber-400"
                  />
                </div>
                <div>
                  <span className="text-[9px] font-bold uppercase tracking-widest text-slate-400">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 w-full rounded-md border border-rose-200 bg-rose-50 px-3 py-2 text-base font-bold text-rose-700 outline-none transition-colors focus:border-rose-500 focus:ring-1 focus:ring-rose-500"
                  />
                </div>
              </div>
            </div>
