          ...
          <table className="w-full min-w-225 border-collapse text-left">
            <thead className="bg-slate-50">
              <tr className="border-b border-slate-200">
                ...
                <th className="w-56 p-4 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                  Pengguna
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {isLoading ? (
                ...
                filteredLogs.map((log, index) => (
                  ...
                  >
                    <td className="p-4 text-center text-sm font-medium text-slate-500 whitespace-nowrap">
                      {index + 1}
                    </td>
                    ...
                    <td className="p-4">
                      <p className="text-sm font-bold text-blue-950 line-clamp-2">
                        {log.description}
                      </p>
                    </td>

                    <td className="p-4">
                      <p className="text-sm font-bold uppercase text-slate-700 line-clamp-1">
