...
// Mock Data Log Khusus BPBD Kabupaten Bandung
const MOCK_LOGS = [
    ...
    <div className="p-6 lg:p-10 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto"> 
        ...
        <div className="mb-8 flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          <div>
            <h1 className="text-2xl font-black text-blue-950 uppercase tracking-tight">Log Aktivitas Kabupaten</h1>
            <p className="text-slate-600 text-sm mt-1 tracking-wide font-medium">Riwayat perubahan data dan aksi personil Pusdalops BPBD Kabupaten Bandung.</p>
          </div>
