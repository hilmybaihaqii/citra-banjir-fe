...
import { AddUserBBWSModal } from "@/components/ui/modal/AddUserBBWSModal";
        ...
        <div className="flex shrink-0 items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
          ...
          <div>
            ...
            <p className="mt-1 text-xs font-medium text-amber-800 leading-relaxed max-w-3xl">
              Anda login sebagai petugas Balai biasa. Penambahan dan penghapusan
              akun dibatasi khusus untuk Kepala Balai / Master Admin BBWS.
            </p>
          </div>
        </div>
      )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4 text-center">
                        <span
                          className={`inline-flex min-w-22.5 justify-center items-center rounded-sm px-2 py-1.5 text-[9px] font-black uppercase tracking-widest shadow-sm ${
                            isRoleSuper
