...
import { MapPinned, Users, AlertTriangle } from "lucide-react";
import {
  AreaChart,
  Area,
  BarChart,
...
const severityData = [
  { tingkat: 'Rendah', jumlah: 17, fill: '#3b82f6' },
  { tingkat: 'Sedang', jumlah: 18, fill: '#f59e0b' },
  { tingkat: 'Tinggi', jumlah: 12, fill: '#ef4444' },
];

const statusData = [
  { name: 'Baru', value: 15, color: '#f43f5e' },
  { name: 'Diproses', value: 8, color: '#f59e0b' },
  { name: 'Selesai', value: 24, color: '#10b981' },
];
  ...
  return (
    <div className="flex flex-col gap-6 pb-8 lg:gap-8">
      ...
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm font-medium tracking-wide text-slate-500">
            Ringkasan Data Kebencanaan Wilayah Jawa Barat
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
        ...
        <div className="flex flex-col justify-between rounded-md border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
          <div className="mb-4 flex items-center gap-3">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Area Terdampak</p>
          </div>
          <h3 className="text-3xl font-black tracking-tight text-blue-950">
            3 <span className="ml-1 text-xs font-bold text-slate-400">Kecamatan</span>
          </h3>
        </div>
        ...
        <div className="flex flex-col justify-between rounded-md border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
          ...
          <h3 className="text-3xl font-black tracking-tight text-blue-950">
            128 <span className="ml-1 text-xs font-bold text-slate-400">Jiwa</span>
          </h3>
        </div>

        <div className="flex flex-col justify-between rounded-md border border-red-200 bg-red-50 p-6 shadow-sm transition-shadow hover:shadow-md sm:col-span-2 lg:col-span-1">
          <div className="mb-4 flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
        ...
        <div className="flex flex-col rounded-md border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2 lg:p-8">
          <div className="mb-8">
