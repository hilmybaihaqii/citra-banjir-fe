...
// Mock Data Log Seluruh Instansi
const MOCK_LOGS = [
  { id: 1, time: "28 Feb 2026, 05:30 WIB", agencyId: "bbws", userName: "Operator BBWS", action: "UPDATE" },
  { id: 2, time: "27 Feb 2026, 14:15 WIB", agencyId: "admin", userName: "Developer Pusat", action: "DELETE" },
  { id: 3, time: "27 Feb 2026, 10:05 WIB", agencyId: "admin", userName: "Developer Pusat", action: "ADD" },
  { id: 4, time: "26 Feb 2026, 08:45 WIB", agencyId: "bmkg", userName: "Staff Analis BMKG", action: "UPDATE" },
  { id: 5, time: "26 Feb 2026, 07:12 WIB", agencyId: "bpbd", userName: "Komandan BPBD Jabar", action: "LOGIN" },
  { id: 6, time: "25 Feb 2026, 21:00 WIB", agencyId: "bpbd_kab", userName: "Petugas BPBD Kab. Bandung", action: "UPDATE" },
  { id: 7, time: "25 Feb 2026, 16:30 WIB", agencyId: "admin", userName: "Admin Moderator", action: "SETTING" },
];
...
export default function AdminLogs() {
  ...
  const filteredLogs = MOCK_LOGS.filter(log => 
    ...
    (AGENCIES[log.agencyId] || "").toLowerCase().includes(searchQuery.toLowerCase())
  );
    ...
    <div className="p-6 lg:p-10">
      <div className="max-w-7xl mx-auto"> 
        ...
        <div className="mb-8 flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          <div>
            <h1 className="text-2xl font-black text-blue-950 uppercase tracking-tight">Log Aktivitas Sistem</h1>
            <p className="text-slate-600 text-sm mt-1 tracking-wide font-medium">Pantau riwayat aksi pengguna dari seluruh instansi.</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Cari pengguna/instansi..." 
                value={searchQuery}
        ...
        <div className="bg-white border border-slate-300 rounded-sm shadow-sm overflow-hidden">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-100 border-b border-slate-300">
                  ...
                  <th className="p-4 text-[10px] font-bold text-slate-700 uppercase tracking-widest">Pengguna & Instansi</th>
                </tr>
              </thead>
                ...
                {filteredLogs.length > 0 ? (
                  filteredLogs.map((log, index) => (
                    <tr key={log.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="p-4">
                        <p className="text-sm font-bold text-blue-950">{log.userName}</p>
                        <p className="text-[11px] text-slate-600 mt-1 uppercase tracking-wider font-bold">
                          {AGENCIES[log.agencyId] || "Unknown"}
                        </p>
                      </td>
                    </tr>
                  ))
          ...
          <div className="p-4 border-t border-slate-300 bg-slate-50 flex items-center justify-between">
            <p className="text-xs text-slate-700 font-medium">Menampilkan <span className="font-bold text-blue-950">{filteredLogs.length}</span> aktivitas</p>
