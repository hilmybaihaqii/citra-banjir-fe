...
const validateInput = (name: string, value: string) => {
  switch (name) {
    ...
    case "phone":
      if (!/^[0-9+]+$/.test(value))
        return "Hanya angka dan tanda + yang diperbolehkan.";
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!contentType || !contentType.includes("application/json")) {
        throw new Error(
          "Server tidak merespon dengan format JSON. Periksa koneksi atau URL API Anda.",
        );
      }
      ...
      {status === "success" ? (
        ...
        >
          ...
          <p className="text-slate-500 mb-12 max-w-lg mx-auto text-lg leading-relaxed font-light">
            Laporan Anda telah berhasil masuk ke sistem kami. Partisipasi Anda
            adalah langkah nyata menuju wilayah yang lebih aman dan tangguh
            bencana.
          </p>
