...
export const AddUserKabModal: React.FC<AddUserModalProps> = ({ isOpen, onClose, onAdd }) => {
  // Inisialisasi state dengan tipe role dan agencyId khusus Kabupaten
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        // Mengirim data sesuai kontrak interface User
        onAdd({
          username: formData.username,
          name: formData.name,
          password: formData.password,
          agencyId: "bpbd_kab", // Dipastikan selalu BPBD Kabupaten
          role: formData.role, 
        });
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="bg-blue-50/50 border border-blue-100 p-3 rounded-sm flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-blue-950">BPBD KABUPATEN BANDUNG</p>
              </div>
            </div>
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange} 
                placeholder="Contoh: bpbd_kab_01"
