    ...
    <>
      <motion.nav
        ...
        className={`${outfit.className} fixed top-0 left-0 right-0 z-50 transition-all duration-500 border-b border-amber-500/80 ${
          scrolled || isOpen ? "shadow-2xl py-1" : "py-2"
        }`}
      >
        <BackgroundPattern />
        <div className="w-full px-4 md:px-6 relative z-10">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="hidden xl:flex items-center space-x-1">
              ...
              <DesktopNavLink
                href="/infografis"
                active={pathname === "/infografis"}
              >
                Infografis Bencana
              </DesktopNavLink>
              <DesktopNavLink href="/lapor" active={pathname === "/lapor"}>
                Lapor
              </DesktopNavLink>
              <DesktopNavLink href="/kontak" active={pathname === "/kontak"}>
                Kontak
              </DesktopNavLink>
              <DesktopNavLink href="/saran" active={pathname === "/saran"}>
                Masukan & Saran
              </DesktopNavLink>
